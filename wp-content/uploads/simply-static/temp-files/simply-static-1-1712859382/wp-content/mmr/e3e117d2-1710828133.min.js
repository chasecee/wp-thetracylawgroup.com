...
/******************
MMR MERGED: /wp-content/plugins/wp-smartcrop/js/jquery.wp-smartcrop.min.js
***************/
...
/******************
MMR MERGED: /wp-content/themes/understrap-child/js/child-theme.min.js
***************/
...
;jQuery(document).ready(function($){var iframeElement=$('.iframe_lazy');var iframeURL=$(iframeElement).data('src');$(iframeElement).addClass('iframe_loading');setTimeout(function(){$(iframeElement).attr('src',iframeURL).removeClass('iframe_loading')},2000)});