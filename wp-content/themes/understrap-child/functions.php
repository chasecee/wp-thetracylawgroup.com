...
function add_lazy_loading_to_attachment_images($attr, $attachment, $size)
{
    // Add the loading attribute and set it to 'lazy' or 'eager'
    $attr['loading'] = 'lazy'; // Change 'lazy' to 'eager' if you want the image to load as soon as possible
