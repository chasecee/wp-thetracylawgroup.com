...
function understrap_all_excerpts_get_more_link( $post_excerpt ) {
    if ( ! is_admin() ) {
        $post_excerpt = $post_excerpt . ' <p><a class="text-smaller font-bold text-primary understrap-read-more-link" href="' . esc_url( get_permalink( get_the_ID() ) ) . '">' . __( 'CONTINUE READING',
        'understrap' ) . '</a></p>';
    }
    return $post_excerpt;
}
/** REMOVE WP ICONS AND SEO ICONS */
